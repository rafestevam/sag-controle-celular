...
class FuncionarioResource(Resource):
    ...
    def get(self, id):
        try:
            ...
            if not funcionario:
                return {"mensagem": "Funcionario não encontrado"}, 400
...
class FuncionarioListResource(Resource):
    ...
    def post(self):
        try:
            ...
            if funcionario:
                return {"mensagem": f"Funcionario com o CPF {cpf} já existente"}
    ...
    def get(self):
        try:
            ...
            return {"mensagem": "Não há funcionários cadastrados na base"}, 400
        except RuntimeError as e:
            return {"mensagem": f"Erro interno {str(e)}"}, 500